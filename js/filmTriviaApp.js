...
$(document).ready(function() {
  ...
  $('#film-trivia-tab').click(function() {
    // Your film trivia script goes here
    console.log('Film Trivia tab clicked');
    //fetchTriviaQuestions('https://opentdb.com/api.php?amount=50&category=11');
});

  const triviaContainer = $('#film-trivia-container');
  const resultContainer = $('#film-result-container');
