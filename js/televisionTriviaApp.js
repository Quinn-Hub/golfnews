...
$(document).ready(function() {
  ...
  $('#tv-trivia-tab').click(function() {
    // Your television trivia script goes here
    console.log('Television Trivia tab clicked');
    //fetchTriviaQuestions('https://opentdb.com/api.php?amount=50&category=14');
});
  ...
  $('nav li').click(function() {
      ...
      fetchTriviaQuestions(tabId); // Fetch trivia question based on the selected tab
  });

  const triviaContainer = $('#tv-trivia-container');
  const resultContainer = $('#tv-result-container');
